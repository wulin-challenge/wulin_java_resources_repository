...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <bottom size="147px" id="borderLayout-bottom1"><xui:place control="view1" id="controlPlace6" style="position:relative;height:100%;width:103%;"></xui:place></bottom></xhtml:div>
  </xui:layout> 
  <xui:view auto-load="true" id="view1" class="xui-container">
   <layout type="absolute" style="position:relative;" id="layout1"><xui:place control="openPic" id="controlPlace3" style="position:absolute;width:84px;top:46px;left:5px;"></xui:place>
  <xui:place control="setPin1" id="controlPlace4" style="position:absolute;width:76px;top:46px;left:97px;"></xui:place>
  <xui:place control="setPin2" id="controlPlace5" style="position:absolute;width:68px;top:46px;left:184px;"></xui:place>
  <xui:place control="closePic" id="controlPlace8" style="position:absolute;width:86px;top:46px;left:261px;"></xui:place>
  <xui:place control="firstPic" id="controlPlace12" style="position:absolute;top:46px;left:380px;"></xui:place>
  <xui:place control="upPic" id="controlPlace13" style="position:absolute;top:46px;left:457px;"></xui:place>
  <xui:place control="nextPic" id="controlPlace14" style="position:absolute;top:46px;left:710px;"></xui:place>
  <xui:place control="lastPic" id="controlPlace15" style="position:absolute;width:67px;top:46px;left:782px;"></xui:place>
  <xui:place control="xuanZhuanPic" id="controlPlace16" style="position:absolute;top:78px;left:380px;"></xui:place>
  <xui:place control="deletePic" id="controlPlace17" style="position:absolute;top:78px;left:782px;"></xui:place>
  <xui:place control="uploadPic" id="controlPlace18" style="position:absolute;left:710px;top:113px;"></xui:place>
  <xui:place control="cancelP" id="controlPlace19" style="position:absolute;top:114px;left:782px;"></xui:place>
  <xhtml:input type="text" value="" id="fileName" style="position:absolute;width:232px;top:114px;left:458px;" class="xui-input"></xhtml:input>
  <xui:place control="upMove" id="controlPlace20" style="position:absolute;top:78px;left:457px;"></xui:place>
  <xui:place control="nextMove" id="controlPlace21" style="position:absolute;top:78px;left:710px;"></xui:place>
  <xui:place control="fasterSao" id="controlPlace23" style="position:absolute;width:79px;top:113px;left:90px;"></xui:place>
  <xui:place control="getPic" id="controlPlace9" style="position:absolute;top:78px;left:184px;"></xui:place>
  <xui:place control="picColor" id="controlPlace22" style="position:absolute;height:23px;width:84px;top:78px;left:89px;"></xui:place>
  <xui:place control="textTo" id="controlPlace10" style="position:absolute;height:23px;top:78px;left:539px;"></xui:place>
  <xhtml:label id="label1" style="position:absolute;top:117px;left:386px;" class="xui-label"><![CDATA[文件名：]]></xhtml:label>
  <xhtml:label id="label2" style="position:absolute;top:82px;left:660px;" class="xui-label"><![CDATA[张]]></xhtml:label>
  <xhtml:input type="text" value="" id="textToNum" class="xui-input" 
  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"
  style="position:absolute;position:absolute;width:29px;height:18px;top:78px;left:619px;"></xhtml:input>
  <xhtml:label id="fileLabel" style="position:absolute;top:50px;left:559px;" class="xui-label"><![CDATA[当前无预览，共0张]]></xhtml:label>
  <xhtml:label id="label5" class="xui-label" style="position:absolute;position:absolute;top:84px;left:8px;"><![CDATA[照片格式：]]></xhtml:label>
  <xui:place control="fileScan" id="controlPlace24" style="position:absolute;width:80px;top:113px;left:176px;"></xui:place>
  <xui:place control="fileScanClose" id="controlPlace25" style="position:absolute;width:80px;top:113px;left:266px;"></xui:place>
  <xui:place control="gridSelect2" id="controlPlace27" style="position:absolute;width:56px;top:115px;left:12px;"></xui:place>
  <xui:place control="SoScan" id="controlPlace2" style="position:absolute;width:85px;top:78px;left:263px;"></xui:place>
  <xui:place control="openOldScan" id="controlPlace7" style="position:absolute;width:103px;top:46px;left:892px;"></xui:place>
  <xui:place control="oldScan" id="controlPlace26" style="position:absolute;width:106px;top:78px;left:892px;"></xui:place>
  <xui:place control="getOldPic" id="controlPlace30" style="position:absolute;width:114px;top:113px;left:892px;"></xui:place></layout>
  ...
  <xforms:action id="action21" ev:event="DOMActivate"><xforms:script id="xformsScript21"><![CDATA[ConCamera.SoScanClick(event)]]></xforms:script></xforms:action></xforms:trigger>
  <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="openOldScan">
   <xforms:label id="default41"><![CDATA[开启旧式扫描仪]]></xforms:label>
  <xforms:action id="action23" ev:event="DOMActivate"><xforms:script id="xformsScript23"><![CDATA[ConCamera.openOldScanClick(event)]]></xforms:script></xforms:action></xforms:trigger>
  <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="oldScan">
   <xforms:label id="default42"><![CDATA[旧式扫描仪扫描]]></xforms:label>
  <xforms:action id="action22" ev:event="DOMActivate"><xforms:script id="xformsScript22"><![CDATA[ConCamera.oldScanClick(event)]]></xforms:script></xforms:action></xforms:trigger>
  <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="getOldPic">
   <xforms:label id="default45"><![CDATA[获取旧式扫描图像]]></xforms:label>
  <xforms:action id="action24" ev:event="DOMActivate"><xforms:script id="xformsScript24"><![CDATA[ConCamera.getOldPicClick(event)]]></xforms:script></xforms:action></xforms:trigger></xui:view>
  <xui:view auto-load="true" id="view2" class="xui-container">
   <layout type="flow" style="position:relative;" id="layout2">
   	<xhtml:div id="contentHolder" class="xui-container" style="height:323px;width:622px;">
		 ...
		 <!-- 690 380 -->
		<xhtml:div id="commonDivId" style="clear: both; width: 1150px; height: 340px;border:1px solid blue">
			<xhtml:div>
				<!--<xhtml:iframe name="FileScan3125cName" src="http://120.90.2.190:8080/test/oldTT.html" width="0" height="0"></xhtml:iframe>
				-->
				<xhtml:iframe name="FileScan3125cName" src="http://127.0.0.1:8080/test/oldTT.html" width="0" height="0"></xhtml:iframe>
			</xhtml:div>
			...
			<xhtml:div id="cameraDivId" style="width: 39%; height: 100%;float:left;border:1px solid green;">
				<!-- 高拍仪 -->
		   		 <xhtml:object id="VideoInputCtl" classid="CLSID:454C18E2-8B7D-43C6-8C17-B1825B49D7DE" style="width: 100%; height: 100%;">
		   		 </xhtml:object>
		    </xhtml:div>
		    <xhtml:div id="pictureDivId" style="width: 59%; height: 100%;float:right;border:1px solid red;">
