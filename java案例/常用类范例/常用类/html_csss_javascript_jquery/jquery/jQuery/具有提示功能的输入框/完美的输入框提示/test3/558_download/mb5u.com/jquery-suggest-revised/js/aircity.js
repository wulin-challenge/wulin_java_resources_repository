...
var commoncitys=new Array();
 var data = ['上海','黄岩','北京','上海','广州','成都','杭州','义乌','黄岩','北京','上海','广州','成都','杭州','义乌','黄岩','北京','上海','广州','成都','杭州','义乌'];
 var dataLength = data.length;
 for(var i=0;i<dataLength;i++){
	var pinyin2 = codefans_net_CC2PY2(data[i]);
	var pinyin3 = codefans_net_CC2PY3(data[i]);
	commoncitys[i]=new Array(i,data[i],pinyin2,pinyin3);
 }
